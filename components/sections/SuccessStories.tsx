...
const stories = [
  {
    ...
    beforeImage: '/assets/images/dentalimplant-01.jpg',
    afterImage: '/assets/images/smiledesigning-01.jpg',
  ...
  },
  {
    ...
    beforeLabel: 'Before Treatment',
    afterLabel: 'After Treatment',
    beforeImage: '/assets/images/skinlightening-01.jpg',
    afterImage: '/assets/images/FACE-1024x683.jpg',
  ...
  },
  {
    ...
    beforeLabel: 'Before Treatment',
    afterLabel: 'After Treatment',
    beforeImage: '/assets/images/HAIRPRP-01.jpg',
    afterImage: '/assets/images/HAIRGFCC2-01.jpg',
  ...
  },
  {
    ...
    beforeLabel: 'Before Treatment',
    afterLabel: 'After Treatment',
    beforeImage: '/assets/images/Orthopaedic-01-1024x683.jpg',
    afterImage: '/assets/images/Orthopaedic-01-1024x683.jpg',
  ...
  },
  {
    ...
    beforeLabel: 'Before Treatment',
    afterLabel: 'After Treatment',
    beforeImage: '/assets/images/Dermatology-01-1024x683.jpg',
    afterImage: '/assets/images/LASER2-01.jpg',
  ...
  },
  {
    ...
    beforeLabel: 'Before Treatment',
    afterLabel: 'After Treatment',
    beforeImage: '/assets/images/DENTAL-PIC-scaled.jpg',
    afterImage: '/assets/images/DENTAL-TREATMENT-1024x683.jpg',
...
type StoryType = typeof stories[0]

function ImageCompare({ beforeImage, afterImage, beforeLabel, afterLabel }: { beforeImage: string; afterImage: string; beforeLabel: string; afterLabel: string }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-y-0 w-0.5 bg-white shadow-[0_0_8px_rgba(0,0,0,0.5)]" style={{ left: `${pos}%` }}>
    ...
    <div className="flex h-full flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-[0_10px_40px_-15px_rgba(2,132,199,0.2)]">
      ...
      <div className="flex flex-1 flex-col gap-4 p-5">
        ...
        <div className="rounded-2xl bg-slate-50 p-4">
          ...
          <p className="line-clamp-3 text-xs leading-relaxed italic text-slate-600">&quot;{story.story}&quot;</p>
          <div className="mt-3 flex items-center justify-between">
            <div>
              <p className="text-xs font-semibold text-slate-800">
                {story.patientName}, {story.patientAge}
              </p>
        ...
        <p className="text-[10px] leading-relaxed text-slate-400">⚕ {story.disclaimer}</p>
      </div>
    </div>
  )
}
  ...
  return (
    <section className="container-shell rounded-[2rem] bg-gradient-to-b from-sky-50/60 to-white py-14">
        ...
        <div className="mt-8 flex items-center justify-center gap-3">
          ...
          {Array.from({ length: totalPages }).map((_, i) => (
            <button
              key={i}
              onClick={() => setPage(i)}
              className={`h-2 rounded-full transition-all ${i === page ? 'w-8 bg-sky-600' : 'w-2 bg-slate-300 hover:bg-slate-400'}`}
              aria-label={`Page ${i + 1}`}
            />
          ))}
          <button
      ...
      <Reveal className="mt-10 rounded-3xl bg-gradient-to-r from-sky-900 to-indigo-900 p-8 text-center text-white">
        <p className="mb-2 text-xs font-bold uppercase tracking-widest text-sky-300">Start Your Own Success Story</p>
        <h3 className="mb-3 text-2xl font-bold">Could this be you? Let&apos;s find out together.</h3>
        <p className="mx-auto mb-6 max-w-lg text-sm text-sky-100">
          Every transformation started with one appointment. Our specialists will evaluate your condition honestly and recommend only what you truly need.
        </p>
        <div className="flex flex-wrap justify-center gap-3">
          ...
          <a
            href={toWhatsAppLink(siteData.contact.whatsapp, 'Hi! I saw the patient success stories and would like to book a consultation.')}
            target="_blank"
            rel="noopener noreferrer"
      ...
      <p className="mt-6 text-center text-xs text-slate-400">
        ⚕ All stories reflect individual patient experiences. Results are not guaranteed and vary based on individual health conditions, treatment compliance, and clinical factors. Consultations are recommended to determine suitability for any treatment.
      </p>
    </section>
  )
}
