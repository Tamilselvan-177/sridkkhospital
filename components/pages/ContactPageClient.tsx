...
function QuickContactBar({ siteData }: { siteData: typeof SiteDataType }) {
  return (
    <div className="grid gap-3 sm:grid-cols-3">
      ...
      <a
        href={toWhatsAppLink(siteData.contact.whatsapp, "Hi! I'd like to enquire about treatment at SRI DKK Hospital.")}
        target="_blank"
...
function TrustSidebar({ siteData }: { siteData: typeof SiteDataType }) {
  return (
...
export function ContactPageClient({ siteData }: { siteData: typeof SiteDataType }) {
  return (
    <>
      <section className="bg-gradient-to-br from-sky-900 via-sky-800 to-indigo-900 py-14 text-white">
        <div className="container-shell text-center">
          ...
          <Reveal>
            <QuickContactBar siteData={siteData} />
          </Reveal>
        </div>
      </section>
      ...
      <section className="container-shell py-12">
        <div className="grid gap-8 lg:grid-cols-[1fr_380px]">
          ...
          <Reveal>
            <TrustSidebar siteData={siteData} />
          </Reveal>
        </div>
      </section>
